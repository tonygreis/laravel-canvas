...
<head>
    ...
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/10.6.0/styles/dracula.min.css" data-turbolinks-track="true">
...
<script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/10.6.0/highlight.min.js" data-turbolinks-track="true"></script>
<script data-turbolinks-track="true">hljs.highlightAll();</script>
@if(isset($script))
    {{ $script }}
@endif
</body>
